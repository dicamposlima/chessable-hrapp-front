...
const DepartmentsListWithFilter = props => {
        ...
        <React.Fragment>
            ...
            <Box component="div" className={classes.header}>
                <Typography variant="overline" gutterBottom>
                    Departments with more than {props.employees} employees (salary {'>'} {props.salary}).
                </Typography>
            </Box>
            <CustomDivider />
            <TableContainer>
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align={'right'}><strong>Quantity (employees)</strong></TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                    {
                        ...
                        ?
                            ...
                            <TableRow key={department.id}>
                                ...
                                <TableCell component="th" scope="row" align={'right'}>{department.x_employees_x_salary}</TableCell>
                            </TableRow>
                            ))
                        :
                        searchingData ?
...
export default DepartmentsListWithFilter;